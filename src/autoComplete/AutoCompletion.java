...
public class AutoCompletion extends PlainDocument {
	...
	public AutoCompletion(final JComboBox comboBox) {
		...
		hidePopupOnFocusLoss = System.getProperty("java.version").startsWith(
				"1.5");
	...
	public static void enable(JComboBox comboBox, JFrame frame) {
		// has to be editable
	...
	public static void createAndShowGUI(String[] arr) {
		// the combo box (add/modify items if you like to)
		final JComboBox comboBox = new JComboBox(arr);
		
		
		enable(comboBox, frame);
